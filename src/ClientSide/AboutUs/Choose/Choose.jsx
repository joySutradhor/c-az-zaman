			...
			<div className="grid grid-cols-1 xl:grid-cols-2 gap-[10px] xl:gap-[76px] items-center">
				<div>
					...
					<p className="heroPara text-[#131212]/[.6] pb-[30px]">
						At “Authentic Zaman”, we love bringing your thoughts to life,
						because it&apos;s built for only one: you. With a company to deliver
						breathtaking, creative, unique interior designs that will blend
						functionality with style, brought about by expert and professional
						interior designers. A focus on quality and details allows for
						personal commitment in every phase. Be it residential or commercial,
						Authentic Zaman strives for innovation and authenticity in every
						project undertaken, ensuring each design reflects who you are. Come
						to us for space that inspires and transforms, tailor-made just for
						you.
					</p>
				</div>
